...
const Form12Players = ({ setPlayersDrive, setPlayersReves, lottery }) => {
  ...
  const handleSubmit = () => {
    ...
    const playersReves = [];
    playersReves.push({ id: 7, name: reference.current.player7.value });
    playersReves.push({ id: 8, name: reference.current.player8.value });
