...
const Form8Players = ({ setPlayersDrive, setPlayersReves, lottery }) => {
  ...
  const handleSubmit = () => {
    ...
    const playersReves = [];
    playersReves.push({ id: 5, name: reference.current.player5.value });
    playersReves.push({ id: 6, name: reference.current.player6.value });
