...
const Form16Players = ({ setPlayersDrive, setPlayersReves, lottery }) => {
  ...
  const handleSubmit = () => {
    ...
    playersDrive.push({ id: 3, name: reference.current.player3.value });
    playersDrive.push({ id: 4, name: reference.current.player4.value });
    playersDrive.push({ id: 5, name: reference.current.player5.value });
    playersDrive.push({ id: 6, name: reference.current.player6.value });
    playersDrive.push({ id: 7, name: reference.current.player7.value });
    playersDrive.push({ id: 8, name: reference.current.player8.value });
    setPlayersDrive(playersDrive);
    const playersReves = [];
    playersReves.push({ id: 9, name: reference.current.player9.value });
    playersReves.push({ id: 10, name: reference.current.player10.value });
    playersReves.push({ id: 11, name: reference.current.player11.value });
    playersReves.push({ id: 12, name: reference.current.player12.value });
    playersReves.push({ id: 13, name: reference.current.player13.value });
    playersReves.push({ id: 14, name: reference.current.player14.value });
    playersReves.push({ id: 15, name: reference.current.player15.value });
    playersReves.push({ id: 16, name: reference.current.player16.value });
